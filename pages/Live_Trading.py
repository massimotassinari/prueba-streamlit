...
# Define allowed tickers manually
allowed_tickers = ["MSFT", "AAPL", "GOOGL", "TSLA", "AMZN"]
...
with params_col:
    with st.form(key='params_form'):
        ...
        ticker = st.selectbox('Select Stock Ticker', available_tickers, key='ticker_selectbox')
